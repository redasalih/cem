...
class CatListDisplayer {
  ...
  private function lcp_build_post($single, $tag){
    ...
    if (!empty($this->params['content_tag'])):
      ...
      $lcp_display_output .= '<div class="thumb">'.$this->get_thumbnail($single).'</div>';

      $lcp_display_output .= '<div class="contenu">';

      $lcp_display_output .= '<div class="titre">'.$this->get_post_title($single).'</div>';


      if (!empty($this->params['excerpt_tag'])):
        $lcp_display_output.='<div class="extra">';
      ...
      $lcp_display_output .= '<div class="detail">';

         // Date
        if (!empty($this->params['date_tag']) || !empty($this->params['date_class'])):
          $lcp_display_output .= '<div class="date">';
        ...
        $lcp_display_output .= '<div class="moreLink">'.$this->get_posts_morelink($single).'</div>';
 ...
 */
  ...
  private function get_thumbnail($single, $tag = null){
    $this->params['thumbnail_class'] = "thumb";
