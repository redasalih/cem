	...
	$testimonial_pinterest = get_post_meta( get_the_ID(), 'testimonial_pinterest', true );	
			...
			$testimonial_body.= '
				...
				if(!empty($testimonial_member_position))
					{
						$testimonial_body.= ' - <div class="testimonial-position" style="display:inline-block; color:'.$testimonial_items_position_color.' !important;font-size:'.$testimonial_items_position_font_size.'">'.$testimonial_member_position.'
						</div>';
					}
