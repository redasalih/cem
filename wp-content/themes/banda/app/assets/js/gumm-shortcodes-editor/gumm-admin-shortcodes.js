    ...
    tinymce.create('tinymce.plugins.gumm_shortcodes_editor', {
        init : function(ed, url) {
            ...
            ed.addButton('gumm-shortcodes-editor-button', {
				...
				onclick: function() {
					ed.execCommand('openGummShortcodesEditor', this._id, ed);
				}
            });
            ...
            ed.addButton('gumm-shortcodes-column-button', {
				...
				onclick: function() {
					ed.execCommand('openGummShortcodesColumnsEditor', this._id, ed);
				}
            });
            ...
            // INIT BUTTON
            ed.addCommand('openGummShortcodesEditor', function(_id) {
                ...
                }, null, _id ? jQuery('#' + _id) : null);
            });
            
            ed.addCommand('openGummShortcodesListEditor', function(_id) {
            ...
            ed.addCommand('openGummShortcodesColumnsEditor', function(_id) {
                var shortcodesListEditor = new jQuery.gummPopup({
                    width: 640,
                    height: 680,
                    url: ajaxurl,
            ...
            ed.addCommand('openGummPokerHandPaster', function(_id){
            ...
            // OTHER COMMANDS
			ed.getGummShortcodeString = function(ui, v) {
            ...
            ed.addCommand('gummInsertShortcode', function(ui, v){
				...
				var scString = ed.getGummShortcodeString(false, v);
                if (scString) {
