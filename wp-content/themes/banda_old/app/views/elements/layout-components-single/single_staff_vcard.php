...
class SingleStaffVcardLayoutElement extends GummLayoutElement {
    ...
    protected function _render($options) {
        ...
        $website    = $this->Wp->getPostMeta($post->ID, 'postmeta.wesite');
        ...
        if ($website) {
            $birthMetaString .= '<a href="http://'.$website.'"> <i class="icon-link"></i>' . $website.'</a>';
        }
        
        echo '<div class="' . $this->Layout->getLayoutColumnsNumberClassName(1) . '">';
?>
        <div class="member-info-wrap">
            <div class="member-info-wrap-centenu">
                <?php
